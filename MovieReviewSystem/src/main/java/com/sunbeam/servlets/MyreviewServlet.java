	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.println("<body>");
			...
			System.out.println("my id:"+user.getId());
				...
				{
					List <ReviewPojo> list=rd.displayMyReviews(user.getId());
					
					for(ReviewPojo rp:list)
					{
						out.println("<tr><td>"+rp.getId()+"</td><td>"+rp.getMovieId()+"</td><td>"+rp.getReview()+"</td><td>"+rp.rating+"</td><td>"+rp.getUserId()+"</td><td>"+rp.getModified()+"</td><td>"
								+ "<img src='edit.png' alt='Edit' width='35' height='35'/><a href='delete?id=s"+user.getId()+"'><img src='delete.png' alt='delete' width='35' height='35'/></a></td></tr>");
					}
				}catch(Exception e)
				{
					e.printStackTrace();
